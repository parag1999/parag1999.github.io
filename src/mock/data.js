...
export const experienceData = [
  {
    ...
    info: ['Currently working in Asset and Wealth Management under the Software Engineer Program.',
          'Working on automating configuration, generation and scheduling of trade events and documents.'],
    start: 'July 2021',
    end: 'Present',
  ...
  },
  {
    ...
    info: ['Worked on an end to end Interns for Social Good project.',
          'Created a REST server based architecture along with microservices for concentration analysis of the user and React based dashboards for all types of users.'],
    start: 'June 2020',
    end: 'July 2020',
